...
class GrammarLexer(Lexer):
    ...
    symbolicNames = [ "<INVALID>",
            "INT", "PLUS", "MINUS", "STAR", "SLASH", "PERCENT", "LEFT_PAREN", 
            "RIGHT_PAREN", "SEMICOLON", "SMALLER_OP", "GREATER_OP", "EQUAL_OP", 
            "SMALLER_E_OP", "GREATER_E_OP", "NOT_EQUAL_OP", "AND_OP", "OR_OP", 
            "NOT_OP", "WS" ]

    ruleNames = [ "INT", "PLUS", "MINUS", "STAR", "SLASH", "PERCENT", "LEFT_PAREN", 
                  "RIGHT_PAREN", "SEMICOLON", "SMALLER_OP", "GREATER_OP", 
                  "EQUAL_OP", "SMALLER_E_OP", "GREATER_E_OP", "NOT_EQUAL_OP", 
                  "AND_OP", "OR_OP", "NOT_OP", "WS" ]
